...
void main(void)
{
	...
	while (str != "end") {	
		...
		//|----------------------------------------------------|
			...
			//---------------------------------------------------transfer register_to_bineray
			int rd_int_U = atoi(rd_U);
			dec_to_bin(rd_int_U, rd_b_U, 5);
			//-----------------------------------------------------verify_immediate_value
			i = 0;
			int index = 0;
			int comma = 0;
			while (str[i] != '\0') {
			...
			int imme_int_U = atoi(imme_U);
			dec_to_bin(imme_int_U, imme_b_U, 20);

			machine_code_note[k][0] = imme_b_U[0];
			machine_code_note[k][1] = imme_b_U[1];
			machine_code_note[k][2] = imme_b_U[2];
			machine_code_note[k][3] = imme_b_U[3];
			machine_code_note[k][4] = imme_b_U[4];
			machine_code_note[k][5] = imme_b_U[5];
			machine_code_note[k][6] = imme_b_U[6];
			machine_code_note[k][7] = imme_b_U[7];
			machine_code_note[k][8] = imme_b_U[8];
			machine_code_note[k][9] = imme_b_U[9];
			machine_code_note[k][10] = imme_b_U[10];
			machine_code_note[k][11] = imme_b_U[11];
			machine_code_note[k][12] = imme_b_U[12];
			machine_code_note[k][13] = imme_b_U[13];
			machine_code_note[k][14] = imme_b_U[14];
			machine_code_note[k][15] = imme_b_U[15];
			machine_code_note[k][16] = imme_b_U[16];
			machine_code_note[k][17] = imme_b_U[17];
			machine_code_note[k][18] = imme_b_U[18];
			machine_code_note[k][19] = imme_b_U[19];

			machine_code_note[k][20] = rd_b_U[0];
			machine_code_note[k][21] = rd_b_U[1];
			machine_code_note[k][22] = rd_b_U[2];
			machine_code_note[k][23] = rd_b_U[3];
			machine_code_note[k][24] = rd_b_U[4];

			machine_code_note[k][25] = opcode_U[0];
			machine_code_note[k][26] = opcode_U[1];
			machine_code_note[k][27] = opcode_U[2];
			machine_code_note[k][28] = opcode_U[3];
			machine_code_note[k][29] = opcode_U[4];
			machine_code_note[k][30] = opcode_U[5];
			machine_code_note[k][31] = opcode_U[6];
